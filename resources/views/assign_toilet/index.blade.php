        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="box box-info">
                ...
                <div class="box-body with-border">
                    ...
                    <div class="row">
                        <div class="col-sm-11">
                            <h4 class="card-title mb-0">Assign Toilet</h4>
                        </div><!--col-->

                        <div class="col-sm-1 right">
                            <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                                <a href="{{ route("assign_toilet") }}" class="btn btn-success ml-1" data-toggle="tooltip" data-placement="top" title="Add">Add <i class="fa fa-plus-circle"></i></a>
                            </div><!--btn-toolbar-->
                        </div><!--col-->
                    </div><!--row-->
