        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border text-center">
                    <h3 class="box-title"><?php echo "Edit User"; ?></h3>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                <input class="form-control input-sm" type="text" name="name"
                                                       value="{{ @$user->name }}" id="name" placeholder="User Name"
...
<!--                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control input-sm" type="email" name="email"
                                                       ...
                                                       placeholder="Email Address" maxlength="191" required=""
                                                       autofocus="">
                                            </div>&lt;!&ndash;col&ndash;&gt;
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                <input class="form-control input-sm" type="password" name="password"
                                                       id="password" placeholder="Password" maxlength="191" required=""
                                                       autofocus="">
                                            </div><!--col-->
                                            <div class="col-md-3">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                <input class="form-control input-sm" type="password"
                                                       ...
                                                       placeholder="Confirm Password" maxlength="191" required=""
                                                       autofocus="">
                                            </div><!--col-->
                                            <div class="col-md-3">
                                            </div>
